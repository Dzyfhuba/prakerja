...
const DarkToggle = () => {
  const dark = window ? localStorage.getItem('isdark') == 'true' : false
  ...
  return (
    <label className="swap swap-rotate">
      ...
      <input type="checkbox" className="theme-controller" value="dark" checked={isDark} onChange={() => setIsDark(!isDark)} />
